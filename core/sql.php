...
// Função para criar uma instrução SQL de INSERT
...
// Função para criar uma instrução SQL de DELETE
...
// Função para criar uma instrução SQL de UPDATE
...
// Função para criar uma instrução SQL de SELECT
